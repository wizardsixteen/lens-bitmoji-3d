...
#endif
vec3 l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_0,(vec2(varPos.xz)*Port_Input1_N015)*vec2(uvScale),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).xyz*baseColor;
vec2 l9_2=((((varPackedTex.xy-Port_Center_N085)*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
float l9_3=atan(l9_2.y*Port_Input1_N024,l9_2.x);
float l9_4=(Port_Input0_N027*3.1415927)/clamp(floor(Port_Import_N028),Port_Input1_N030,Port_Input2_N030);
float l9_5=((((1.0-(cos((floor((l9_3/l9_4)+Port_Input1_N033)*l9_4)-l9_3)*length(l9_2)))-Port_RangeMinA_N039)/(clamp(Port_Import_N025,0.0,1.0)-Port_RangeMinA_N039))*(Port_RangeMaxB_N039-Port_RangeMinB_N039))+Port_RangeMinB_N039;
vec4 l9_6=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_6.w=l9_5;
