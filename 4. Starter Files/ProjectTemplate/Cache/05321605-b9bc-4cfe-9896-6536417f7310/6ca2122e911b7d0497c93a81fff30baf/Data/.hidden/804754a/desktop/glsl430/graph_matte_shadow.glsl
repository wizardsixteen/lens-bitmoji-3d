...
{
vec2 l9_15;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_15,l9_8);
float l9_16;
Node67_Bool_Parameter(l9_16,l9_8);
l9_14=mix(l9_5,l9_15,vec2(l9_16));
}
#else
{
vec2 l9_17;
...
#endif
l9_17=mix(l9_5,l9_18,vec2(l9_21-0.001));
}
#else
{
l9_17=l9_5;
...
#endif
l9_9=mix(Port_Input0_N006,l9_11,vec3(l9_22.x));
}
#else
{
vec3 l9_23;
Node0_Shadow_Sample(l9_23,l9_8);
l9_9=l9_23;
}
#endif
vec4 l9_24=vec4(l9_9.x,l9_9.y,l9_9.z,vec4(0.0).w);
l9_24.w=Port_Value2_N001;
...
{
l9_29=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_24.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_24.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_24.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_38;
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_24.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_24.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_54;
...
{
l9_55=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_55=Port_Value2_N001;
}
#endif
