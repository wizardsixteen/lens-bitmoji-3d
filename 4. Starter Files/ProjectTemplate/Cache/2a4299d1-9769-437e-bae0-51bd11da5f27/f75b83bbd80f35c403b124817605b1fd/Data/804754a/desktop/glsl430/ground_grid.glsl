...
vec2 l9_3=(vec2(l9_0.xz)*Port_Input1_N015)*vec2(uvScale);
vec4 l9_4;
#if (baseTexLayout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec3 l9_5=l9_4.xyz*baseColor;
vec2 l9_6=l9_1-Port_Center_N085;
vec2 l9_7=(((l9_6*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
float l9_8=atan(l9_7.y*Port_Input1_N024,l9_7.x);
float l9_9=(Port_Input0_N027*3.1415927)/clamp(floor(Port_Import_N028),Port_Input1_N030,Port_Input2_N030);
float l9_10=((((1.0-(cos((floor((l9_8/l9_9)+Port_Input1_N033)*l9_9)-l9_8)*length(l9_7)))-Port_RangeMinA_N039)/(clamp(Port_Import_N025,0.0,1.0)-Port_RangeMinA_N039))*(Port_RangeMaxB_N039-Port_RangeMinB_N039))+Port_RangeMinB_N039;
vec4 l9_11=vec4(l9_5.x,l9_5.y,l9_5.z,vec4(0.0).w);
l9_11.w=l9_10;
...
{
l9_17=clamp(dot(l9_11.xyz,vec3(l9_10)),0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_19=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*l9_10;
}
#else
{
float l9_20;
...
{
l9_20=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*l9_10;
}
#else
{
float l9_21;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_23=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*l9_10;
}
#else
{
float l9_24;
...
{
l9_24=dot(l9_11.xyz,vec3(0.33333001))*l9_10;
}
#else
{
float l9_25;
...
#endif
vec3 l9_38=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_11.xyz).xyz,vec3(l9_10));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_11.xyz,vec3(l9_10)),l9_10);
}
#else
{
vec4 l9_41;
