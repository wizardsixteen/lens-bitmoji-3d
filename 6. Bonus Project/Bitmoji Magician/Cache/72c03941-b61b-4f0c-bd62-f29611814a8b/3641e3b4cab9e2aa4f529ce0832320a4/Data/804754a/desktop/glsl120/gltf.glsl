...
#endif
N3_Emissive=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(emissiveTextureDims.xy,emissiveTextureLayout,l9_3,l9_2,(int(SC_USE_UV_TRANSFORM_emissiveTexture)!=0),emissiveTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTexture,SC_SOFTWARE_WRAP_MODE_V_emissiveTexture),(int(SC_USE_UV_MIN_MAX_emissiveTexture)!=0),emissiveTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTexture)!=0),emissiveTextureBorderColor,0.0,emissiveTexture).xyz)*ssSRGB_to_Linear(l9_0);
}
...
#endif
N3_Normal=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,l9_4)*mix(vec3(0.0,0.0,1.0),(sc_SampleTextureBiasOrLevel(normalTextureDims.xy,normalTextureLayout,l9_7,l9_6,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture),(int(SC_USE_UV_MIN_MAX_normalTexture)!=0),normalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0),normalTextureBorderColor,0.0,normalTexture).xyz*1.9921875)-vec3(1.0),vec3(N3_NormalScale)));
}
...
#endif
vec4 l9_13=sc_SampleTextureBiasOrLevel(metallicRoughnessTextureDims.xy,metallicRoughnessTextureLayout,l9_12,l9_11,(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture)!=0),metallicRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture),(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture)!=0),metallicRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0),metallicRoughnessTextureBorderColor,0.0,metallicRoughnessTexture);
vec4 l9_14=vec4(0.0);
l9_14.w=N3_OcclusionStrength;
vec3 l9_15=vec3(1.0+(N3_OcclusionStrength*(l9_13.z-1.0)));
N3_Metallic=l9_8*l9_13.x;
N3_Roughness=l9_9*l9_13.y;
N3_Occlusion=vec4(l9_15.x,l9_15.y,l9_15.z,l9_14.w);
}
if (N3_TransmissionEnable)
{
vec3 l9_16=N3_BaseColor;
vec3 l9_17=N3_Emissive;
float l9_18=N3_Metallic;
vec2 l9_19=tempGlobals.gScreenCoord;
int l9_20;
...
#endif
l9_21=sc_SampleTextureBiasOrLevel(transmissionTextureDims.xy,transmissionTextureLayout,l9_24,l9_23,(int(SC_USE_UV_TRANSFORM_transmissionTexture)!=0),transmissionTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture),(int(SC_USE_UV_MIN_MAX_transmissionTexture)!=0),transmissionTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0),transmissionTextureBorderColor,0.0,transmissionTexture).x;
}
else
{
l9_21=1.0;
}
vec3 l9_25=vec3(l9_21*N3_TransmissionFactor);
vec3 l9_26=vec3(l9_18);
N3_BaseColor=mix(mix(l9_16,vec3(0.0),l9_25),l9_16,l9_26);
N3_Emissive=mix(mix(vec3(0.0),l9_16,l9_25)*N3_Background,vec3(0.0),l9_26)+l9_17;
}
N3_BaseColor=ssLinear_to_SRGB(N3_BaseColor);
float l9_27=N3_Opacity;
float l9_28;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_28=pow(l9_27,0.45454544);
}
#else
{
l9_28=sqrt(l9_27);
...
vec4 l9_30=N3_Occlusion;
vec3 l9_31=N3_SheenColorFactor;
float l9_32=N3_SheenRoughnessFactor;
vec3 l9_33;
if (N3_EnableSheenTexture)
{
vec2 l9_34=N3_getUV(N3_SheenColorTextureCoord);
vec2 l9_35;
if (N3_EnableTextureTransform&&N3_SheenColorTextureTransform)
{
l9_35=N3_uvTransform(l9_34,N3_SheenColorTextureOffset,N3_SheenColorTextureScale,N3_SheenColorTextureRotation);
}
else
{
l9_35=l9_34;
...
{
vec2 l9_38=N3_getUV(N3_SheenRoughnessTextureCoord);
vec2 l9_39;
if (N3_EnableTextureTransform&&N3_SheenRoughnessTextureTransform)
{
l9_39=N3_uvTransform(l9_38,N3_SheenRoughnessTextureOffset,N3_SheenRoughnessTextureScale,N3_SheenRoughnessTextureRotation);
}
else
{
l9_39=l9_38;
...
#endif
l9_37=l9_32*ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(sheenRoughnessTextureDims.xy,sheenRoughnessTextureLayout,l9_40,l9_39,(int(SC_USE_UV_TRANSFORM_sheenRoughnessTexture)!=0),sheenRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture),(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture)!=0),sheenRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0),sheenRoughnessTextureBorderColor,0.0,sheenRoughnessTexture).w);
}
else
{
l9_37=l9_32;
}
float l9_41=max(l9_37,9.9999997e-05);
N3_SheenOut=vec4(0.0);
vec3 l9_42=tempGlobals.ViewDirWS;
float l9_43=max(clamp(dot(l9_29,l9_42),0.0,1.0),9.9999997e-05);
float l9_44=l9_41*l9_41;
bool l9_45=l9_41<0.25;
float l9_46;
if (l9_45)
{
l9_46=(((-339.20001)*l9_44)+(161.39999*l9_41))-25.9;
}
else
{
l9_46=(((-8.4799995)*l9_44)+(14.3*l9_41))-9.9499998;
}
float l9_47;
if (l9_45)
{
l9_47=((44.0*l9_44)-(23.700001*l9_41))+3.26;
}
else
{
l9_47=((1.97*l9_44)-(3.27*l9_41))+0.72000003;
}
float l9_48=l9_46*l9_43;
float l9_49=l9_48+l9_47;
float l9_50;
if (l9_45)
{
l9_50=0.0;
...
{
l9_50=0.1*(l9_41-0.25);
}
vec3 l9_51=N3_SheenOut.xyz+((((sampleSpecularEnvTextureLod(normalize(reflect(-l9_42,l9_29)),3.0+((((l9_41*4.0)-0.0)*2.0)/5.0))*sc_EnvmapExposure)+vec3(1e-06))*l9_33)*clamp((exp(l9_49)+l9_50)*3.1415927,0.0,1.0));
N3_SheenOut=vec4(l9_51.x,l9_51.y,l9_51.z,N3_SheenOut.w);
vec3 l9_52=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_30.xyz,vec3(l9_30.w));
N3_SheenOut=vec4(l9_52.x,l9_52.y,l9_52.z,N3_SheenOut.w);
vec3 l9_53;
#if (sc_DirectionalLightsCount>0)
{
vec3 l9_54;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_57=l9_56<sc_DirectionalLightsCount;
if (l9_57)
{
vec3 l9_58;
if (l9_57)
{
l9_58=sc_DirectionalLights[l9_56].color.xyz;
}
else
{
l9_58=vec3(0.0);
...
if (l9_57)
{
l9_59=sc_DirectionalLights[l9_56].color.w;
}
else
{
l9_59=0.0;
}
vec3 l9_60=l9_58*l9_59;
vec3 l9_61;
if (l9_57)
{
l9_61=-sc_DirectionalLights[l9_56].direction;
}
else
{
l9_61=vec3(0.0);
}
vec3 l9_62=normalize(-l9_61);
float l9_63=clamp(dot(l9_29,l9_62),0.0,1.0);
l9_55=l9_54+(((((l9_60*3.1415901)*l9_33)*N3_charlieD(l9_44,clamp(dot(l9_29,normalize(l9_62+l9_42)),0.0,1.0)))*(1.0/(4.0*((l9_63+l9_43)-(l9_63*l9_43)))))*l9_63);
l9_54=l9_55;
l9_56++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_68=l9_67<sc_PointLightsCount;
if (l9_68)
{
vec3 l9_69;
if (l9_68)
{
l9_69=sc_PointLights[l9_67].color.xyz;
}
else
{
l9_69=vec3(0.0);
...
if (l9_68)
{
l9_70=sc_PointLights[l9_67].color.w;
}
else
{
l9_70=0.0;
...
if (l9_68)
{
l9_72=sc_PointLights[l9_67].position;
}
else
{
l9_72=vec3(0.0);
}
vec3 l9_73=normalize(l9_72-tempGlobals.SurfacePosition_WorldSpace);
float l9_74=clamp(dot(l9_29,l9_73),0.0,1.0);
l9_66=l9_65+(((((l9_71*3.1415901)*l9_33)*N3_charlieD(l9_44,clamp(dot(l9_29,normalize(l9_73+l9_42)),0.0,1.0)))*(1.0/(4.0*((l9_74+l9_43)-(l9_74*l9_43)))))*l9_74);
l9_65=l9_66;
l9_67++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_79=l9_78<sc_AmbientLightsCount;
if (l9_79)
{
vec3 l9_80;
if (l9_79)
{
l9_80=sc_AmbientLights[l9_78].color;
}
else
{
l9_80=vec3(0.0);
...
if (l9_79)
{
l9_81=sc_AmbientLights[l9_78].intensity;
}
else
{
l9_81=0.0;
}
l9_77=l9_76+(((l9_80*l9_81)/vec3(3.1415901))*l9_33);
l9_76=l9_77;
l9_78++;
continue;
}
...
#endif
vec3 l9_82=N3_SheenOut.xyz+l9_75;
N3_SheenOut=vec4(l9_82.x,l9_82.y,l9_82.z,N3_SheenOut.w);
N3_SheenOut.w=1.0-(max(max(l9_33.x,l9_33.y),l9_33.z)*0.15700001);
}
...
{
vec2 l9_83=N3_getUV(N3_ClearcoatTextureCoord);
vec2 l9_84;
if (N3_EnableTextureTransform&&N3_ClearcoatTextureTransform)
{
l9_84=N3_uvTransform(l9_83,N3_ClearcoatTextureOffset,N3_ClearcoatTextureScale,N3_ClearcoatTextureRotation);
}
else
{
l9_84=l9_83;
...
#endif
N3_ClearcoatRoughness=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,l9_88,l9_87,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTexture).y);
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
vec2 l9_89=N3_getUV(N3_ClearcoatNormalMapCoord);
vec2 l9_90;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
l9_90=N3_uvTransform(l9_89,N3_ClearcoatNormalTextureOffset,N3_ClearcoatNormalTextureScale,N3_ClearcoatNormalTextureRotation);
}
else
{
l9_90=l9_89;
...
#endif
N3_ClearcoatNormal=sc_SampleTextureBiasOrLevel(clearcoatNormalTextureDims.xy,clearcoatNormalTextureLayout,l9_91,l9_90,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture),(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0),clearcoatNormalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0),clearcoatNormalTextureBorderColor,0.0,clearcoatNormalTexture).xyz;
N3_ClearcoatNormal*=0.9921875;
}
}
vec3 l9_92=N3_BaseColor;
float l9_93=N3_Opacity;
vec3 l9_94=N3_Normal;
vec3 l9_95=N3_Emissive;
float l9_96=N3_Metallic;
float l9_97=N3_Roughness;
vec3 l9_98=N3_Background;
vec4 l9_99=N3_SheenOut;
float l9_100=N3_ClearcoatBase;
vec3 l9_101=N3_ClearcoatNormal;
float l9_102=N3_ClearcoatRoughness;
vec3 l9_103;
...
#else
{
l9_103=Globals.BumpedNormal;
}
#endif
float l9_104=clamp(l9_93,0.0,1.0);
ngsAlphaTest(l9_104);
vec3 l9_105=max(l9_92,vec3(0.0));
vec4 l9_106;
#if (sc_ProjectiveShadowsCaster)
{
l9_106=vec4(l9_105,l9_104);
}
#else
{
l9_106=ngsCalculateLighting(l9_105,l9_104,l9_103,Globals.PositionWS,Globals.ViewDirWS,max(l9_95,vec3(0.0)),clamp(l9_96,0.0,1.0),clamp(l9_97,0.0,1.0),clamp(N3_Occlusion.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
vec4 l9_107=max(l9_106,vec4(0.0));
vec3 l9_108;
#if (!sc_ProjectiveShadowsCaster)
{
l9_108=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_101;
}
#else
{
l9_108=Globals.BumpedNormal;
}
#endif
...
#if (sc_ProjectiveShadowsCaster)
{
l9_109=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#else
{
l9_109=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_108,Globals.PositionWS,Globals.ViewDirWS,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_102,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
tempGlobals=Globals;
N31_PbrIn=l9_107;
...
N31_Opacity=l9_93;
N31_Background=l9_98;
N31_EnableSheen=(int(ENABLE_SHEEN)!=0);
N31_SheenColor=l9_99;
N31_EnableClearcoat=(int(ENABLE_CLEARCOAT)!=0);
N31_ClearcoatBase=l9_100;
N31_ClearcoatColor=max(l9_109,vec4(0.0));
...
if (N31_EnableSheen)
{
vec3 l9_110=(N31_Result.xyz*N31_SheenColor.w)+N31_SheenColor.xyz;
...
{
vec3 l9_111=N31_Result.xyz+(ssSRGB_to_Linear(N31_ClearcoatColor)*N31_ClearcoatBase).xyz;
N31_Result=vec4(l9_111.x,l9_111.y,l9_111.z,N31_Result.w);
}
