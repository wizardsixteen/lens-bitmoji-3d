...
{
l9_3=sc_SampleTextureBiasOrLevel(emissiveTextureDims.xy,emissiveTextureLayout,emissiveTextureGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_emissiveTexture)!=0),emissiveTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTexture,SC_SOFTWARE_WRAP_MODE_V_emissiveTexture),(int(SC_USE_UV_MIN_MAX_emissiveTexture)!=0),emissiveTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTexture)!=0),emissiveTextureBorderColor,0.0,emissiveTextureArrSC);
}
#else
{
l9_3=sc_SampleTextureBiasOrLevel(emissiveTextureDims.xy,emissiveTextureLayout,emissiveTextureGetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_emissiveTexture)!=0),emissiveTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTexture,SC_SOFTWARE_WRAP_MODE_V_emissiveTexture),(int(SC_USE_UV_MIN_MAX_emissiveTexture)!=0),emissiveTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTexture)!=0),emissiveTextureBorderColor,0.0,emissiveTexture);
}
#endif
...
{
vec3 l9_4=N3_Normal;
vec2 l9_5=N3_getUV(N3_NormalTextureCoord);
vec2 l9_6;
if (N3_EnableTextureTransform&&N3_NormalTextureTransform)
{
l9_6=N3_uvTransform(l9_5,N3_NormalTextureOffset,N3_NormalTextureScale,N3_NormalTextureRotation);
}
else
{
l9_6=l9_5;
...
{
l9_7=sc_SampleTextureBiasOrLevel(normalTextureDims.xy,normalTextureLayout,normalTextureGetStereoViewIndex(),l9_6,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture),(int(SC_USE_UV_MIN_MAX_normalTexture)!=0),normalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0),normalTextureBorderColor,0.0,normalTextureArrSC);
}
#else
{
l9_7=sc_SampleTextureBiasOrLevel(normalTextureDims.xy,normalTextureLayout,normalTextureGetStereoViewIndex(),l9_6,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture),(int(SC_USE_UV_MIN_MAX_normalTexture)!=0),normalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0),normalTextureBorderColor,0.0,normalTexture);
...
#endif
N3_Normal=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,l9_4)*mix(vec3(0.0,0.0,1.0),(l9_7.xyz*1.9921875)-vec3(1.0),vec3(N3_NormalScale)));
}
...
{
float l9_8=N3_Metallic;
float l9_9=N3_Roughness;
vec2 l9_10=N3_getUV(N3_MaterialParamsTextureCoord);
vec2 l9_11;
if (N3_EnableTextureTransform&&N3_MaterialParamsTextureTransform)
{
l9_11=N3_uvTransform(l9_10,N3_MaterialParamsTextureOffset,N3_MaterialParamsTextureScale,N3_MaterialParamsTextureRotation);
}
else
{
l9_11=l9_10;
...
#endif
vec4 l9_13=vec4(0.0);
l9_13.w=N3_OcclusionStrength;
vec3 l9_14=vec3(1.0+(N3_OcclusionStrength*(l9_12.z-1.0)));
N3_Metallic=l9_8*l9_12.x;
N3_Roughness=l9_9*l9_12.y;
N3_Occlusion=vec4(l9_14.x,l9_14.y,l9_14.z,l9_13.w);
}
if (N3_TransmissionEnable)
{
vec3 l9_15=N3_BaseColor;
vec3 l9_16=N3_Emissive;
float l9_17=N3_Metallic;
vec2 l9_18=tempGlobals.gScreenCoord;
vec4 l9_19;
#if (screenTextureLayout==2)
{
l9_19=sc_SampleTextureBiasOrLevel(screenTextureDims.xy,screenTextureLayout,screenTextureGetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture),(int(SC_USE_UV_MIN_MAX_screenTexture)!=0),screenTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0),screenTextureBorderColor,0.0,screenTextureArrSC);
}
#else
{
l9_19=sc_SampleTextureBiasOrLevel(screenTextureDims.xy,screenTextureLayout,screenTextureGetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture),(int(SC_USE_UV_MIN_MAX_screenTexture)!=0),screenTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0),screenTextureBorderColor,0.0,screenTexture);
...
#endif
N3_Background=ssSRGB_to_Linear(l9_19.xyz);
float l9_20;
if (N3_EnableTransmissionTexture)
{
vec2 l9_21=N3_getUV(N3_TransmissionTextureCoord);
vec2 l9_22;
if (N3_EnableTextureTransform&&N3_TransmissionTextureTransform)
{
l9_22=N3_uvTransform(l9_21,N3_TransmissionTextureOffset,N3_TransmissionTextureScale,N3_TransmissionTextureRotation);
}
else
{
l9_22=l9_21;
...
vec3 l9_24=vec3(l9_20*N3_TransmissionFactor);
vec3 l9_25=vec3(l9_17);
N3_BaseColor=mix(mix(l9_15,vec3(0.0),l9_24),l9_15,l9_25);
N3_Emissive=mix(mix(vec3(0.0),l9_15,l9_24)*N3_Background,vec3(0.0),l9_25)+l9_16;
}
N3_BaseColor=ssLinear_to_SRGB(N3_BaseColor);
float l9_26=N3_Opacity;
float l9_27;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_27=pow(l9_26,0.45454544);
}
#else
{
l9_27=sqrt(l9_26);
...
if (N3_SheenEnable)
{
vec3 l9_28=N3_Normal;
vec4 l9_29=N3_Occlusion;
vec3 l9_30=N3_SheenColorFactor;
float l9_31=N3_SheenRoughnessFactor;
vec3 l9_32;
if (N3_EnableSheenTexture)
{
vec2 l9_33=N3_getUV(N3_SheenColorTextureCoord);
vec2 l9_34;
if (N3_EnableTextureTransform&&N3_SheenColorTextureTransform)
{
l9_34=N3_uvTransform(l9_33,N3_SheenColorTextureOffset,N3_SheenColorTextureScale,N3_SheenColorTextureRotation);
}
else
{
l9_34=l9_33;
...
#endif
l9_32=l9_30*ssSRGB_to_Linear(l9_35.xyz);
}
else
{
l9_32=l9_30;
...
{
vec2 l9_37=N3_getUV(N3_SheenRoughnessTextureCoord);
vec2 l9_38;
if (N3_EnableTextureTransform&&N3_SheenRoughnessTextureTransform)
{
l9_38=N3_uvTransform(l9_37,N3_SheenRoughnessTextureOffset,N3_SheenRoughnessTextureScale,N3_SheenRoughnessTextureRotation);
}
else
{
l9_38=l9_37;
...
#endif
l9_36=l9_31*ssSRGB_to_Linear(l9_39.w);
}
else
{
l9_36=l9_31;
}
float l9_40=max(l9_36,9.9999997e-05);
N3_SheenOut=vec4(0.0);
vec3 l9_41=tempGlobals.ViewDirWS;
float l9_42=max(clamp(dot(l9_28,l9_41),0.0,1.0),9.9999997e-05);
float l9_43=l9_40*l9_40;
vec3 l9_44=normalize(reflect(-l9_41,l9_28));
float l9_45=3.0+((((l9_40*4.0)-0.0)*2.0)/5.0);
bool l9_46=l9_40<0.25;
float l9_47;
if (l9_46)
{
l9_47=(((-339.20001)*l9_43)+(161.39999*l9_40))-25.9;
}
else
{
l9_47=(((-8.4799995)*l9_43)+(14.3*l9_40))-9.9499998;
}
float l9_48;
if (l9_46)
{
l9_48=((44.0*l9_43)-(23.700001*l9_40))+3.26;
}
else
{
l9_48=((1.97*l9_43)-(3.27*l9_40))+0.72000003;
}
float l9_49=l9_47*l9_42;
float l9_50=l9_49+l9_48;
float l9_51;
if (l9_46)
{
l9_51=0.0;
...
{
l9_51=0.1*(l9_40-0.25);
}
float l9_52=exp(l9_50)+l9_51;
float l9_53=-l9_44.z;
float l9_54=l9_44.x;
vec2 l9_55=vec2((((l9_54<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_53/length(vec2(l9_54,l9_53)),-1.0,1.0)))-1.5707964,acos(l9_44.y))/vec2(6.2831855,3.1415927);
float l9_56=l9_55.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_57=vec2(l9_56,1.0-l9_55.y);
l9_57.x=fract((l9_56+floor(l9_56))+1.0);
vec4 l9_58;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_59=floor(l9_45);
float l9_60=ceil(l9_45);
l9_58=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_57,sc_EnvmapSpecularSize.xy,l9_59),sc_EnvmapSpecularGetStereoViewIndex(),l9_59),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_57,sc_EnvmapSpecularSize.xy,l9_60),sc_EnvmapSpecularGetStereoViewIndex(),l9_60),vec4(l9_45-l9_59));
}
#else
{
l9_58=sc_EnvmapSpecularSampleViewIndexLevel(l9_57,sc_EnvmapSpecularGetStereoViewIndex(),l9_45);
}
#endif
vec3 l9_61=N3_SheenOut.xyz+(((((l9_58.xyz*(1.0/l9_58.w))*sc_EnvmapExposure)+vec3(1e-06))*l9_32)*clamp(l9_52*3.1415927,0.0,1.0));
N3_SheenOut=vec4(l9_61.x,l9_61.y,l9_61.z,N3_SheenOut.w);
vec3 l9_62=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_29.xyz,vec3(l9_29.w));
N3_SheenOut=vec4(l9_62.x,l9_62.y,l9_62.z,N3_SheenOut.w);
vec3 l9_63;
...
{
l9_67=l9_66<sc_DirectionalLightsCount;
if (l9_67)
{
vec3 l9_68;
if (l9_67)
{
l9_68=sc_DirectionalLights[l9_66].color.xyz;
}
else
{
l9_68=vec3(0.0);
...
if (l9_67)
{
l9_69=sc_DirectionalLights[l9_66].color.w;
}
else
{
l9_69=0.0;
}
vec3 l9_70=l9_68*l9_69;
vec3 l9_71;
if (l9_67)
{
l9_71=-sc_DirectionalLights[l9_66].direction;
}
else
{
l9_71=vec3(0.0);
}
vec3 l9_72=normalize(-l9_71);
float l9_73=clamp(dot(l9_28,l9_72),0.0,1.0);
l9_65=l9_64+(((((l9_70*3.1415901)*l9_32)*N3_charlieD(l9_43,clamp(dot(l9_28,normalize(l9_72+l9_41)),0.0,1.0)))*(1.0/(4.0*((l9_73+l9_42)-(l9_73*l9_42)))))*l9_73);
l9_64=l9_65;
l9_66++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_78=l9_77<sc_PointLightsCount;
if (l9_78)
{
vec3 l9_79;
if (l9_78)
{
l9_79=sc_PointLights[l9_77].color.xyz;
}
else
{
l9_79=vec3(0.0);
...
if (l9_78)
{
l9_80=sc_PointLights[l9_77].color.w;
}
else
{
l9_80=0.0;
}
vec3 l9_81=l9_79*l9_80;
vec3 l9_82;
if (l9_78)
{
l9_82=sc_PointLights[l9_77].position;
}
else
{
l9_82=vec3(0.0);
}
vec3 l9_83=normalize(l9_82-tempGlobals.SurfacePosition_WorldSpace);
float l9_84=clamp(dot(l9_28,l9_83),0.0,1.0);
l9_76=l9_75+(((((l9_81*3.1415901)*l9_32)*N3_charlieD(l9_43,clamp(dot(l9_28,normalize(l9_83+l9_41)),0.0,1.0)))*(1.0/(4.0*((l9_84+l9_42)-(l9_84*l9_42)))))*l9_84);
l9_75=l9_76;
l9_77++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_89=l9_88<sc_AmbientLightsCount;
if (l9_89)
{
vec3 l9_90;
if (l9_89)
{
l9_90=sc_AmbientLights[l9_88].color;
}
else
{
l9_90=vec3(0.0);
...
if (l9_89)
{
l9_91=sc_AmbientLights[l9_88].intensity;
}
else
{
l9_91=0.0;
}
l9_87=l9_86+(((l9_90*l9_91)/vec3(3.1415901))*l9_32);
l9_86=l9_87;
l9_88++;
continue;
}
...
#endif
vec3 l9_92=N3_SheenOut.xyz+l9_85;
N3_SheenOut=vec4(l9_92.x,l9_92.y,l9_92.z,N3_SheenOut.w);
N3_SheenOut.w=1.0-(max(max(l9_32.x,l9_32.y),l9_32.z)*0.15700001);
}
...
{
vec2 l9_93=N3_getUV(N3_ClearcoatTextureCoord);
vec2 l9_94;
if (N3_EnableTextureTransform&&N3_ClearcoatTextureTransform)
{
l9_94=N3_uvTransform(l9_93,N3_ClearcoatTextureOffset,N3_ClearcoatTextureScale,N3_ClearcoatTextureRotation);
}
else
{
l9_94=l9_93;
...
#endif
N3_ClearcoatBase=ssSRGB_to_Linear(l9_95.x);
}
N3_ClearcoatBase*=N3_ClearcoatFactor;
if (N3_EnableClearCoatRoughnessTexture)
{
vec2 l9_96=N3_getUV(N3_ClearcoatRoughnessTextureCoord);
vec2 l9_97;
if (N3_EnableTextureTransform&&N3_ClearcoatRoughnessTextureTransform)
{
l9_97=N3_uvTransform(l9_96,N3_ClearcoatRoughnessTextureOffset,N3_ClearcoatRoughnessTextureScale,N3_ClearcoatRoughnessTextureRotation);
}
else
{
l9_97=l9_96;
...
{
l9_98=sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,clearcoatRoughnessTextureGetStereoViewIndex(),l9_97,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTextureArrSC);
}
#else
{
...
#endif
N3_ClearcoatRoughness=ssSRGB_to_Linear(l9_98.y);
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
vec2 l9_99=N3_getUV(N3_ClearcoatNormalMapCoord);
vec2 l9_100;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
l9_100=N3_uvTransform(l9_99,N3_ClearcoatNormalTextureOffset,N3_ClearcoatNormalTextureScale,N3_ClearcoatNormalTextureRotation);
}
else
{
l9_100=l9_99;
...
#endif
N3_ClearcoatNormal=l9_101.xyz;
N3_ClearcoatNormal*=0.9921875;
}
}
float l9_102=N3_Opacity;
vec3 l9_103=N3_Normal;
float l9_104=N3_Roughness;
vec3 l9_105=N3_Background;
vec4 l9_106=N3_SheenOut;
float l9_107=N3_ClearcoatBase;
vec3 l9_108=N3_ClearcoatNormal;
float l9_109=N3_ClearcoatRoughness;
vec3 l9_110;
...
#endif
ngsAlphaTest(clamp(l9_102,0.0,1.0));
sc_WriteReceiverData(Globals.PositionWS,l9_110,l9_104);
vec3 l9_111;
#if (!sc_ProjectiveShadowsCaster)
{
l9_111=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_108;
}
#else
{
...
float l9_42=max(clamp(dot(l9_28,l9_41),0.0,1.0),9.9999997e-05);
float l9_43=l9_40*l9_40;
bool l9_44=l9_40<0.25;
float l9_45;
if (l9_44)
{
l9_45=(((-339.20001)*l9_43)+(161.39999*l9_40))-25.9;
}
else
{
l9_45=(((-8.4799995)*l9_43)+(14.3*l9_40))-9.9499998;
}
float l9_46;
if (l9_44)
{
l9_46=((44.0*l9_43)-(23.700001*l9_40))+3.26;
}
else
{
l9_46=((1.97*l9_43)-(3.27*l9_40))+0.72000003;
}
float l9_47=l9_45*l9_42;
...
{
l9_49=0.1*(l9_40-0.25);
}
vec3 l9_50=N3_SheenOut.xyz+((((sampleSpecularEnvTextureLod(normalize(reflect(-l9_41,l9_28)),3.0+((((l9_40*4.0)-0.0)*2.0)/5.0))*sc_EnvmapExposure)+vec3(1e-06))*l9_32)*clamp((exp(l9_48)+l9_49)*3.1415927,0.0,1.0));
N3_SheenOut=vec4(l9_50.x,l9_50.y,l9_50.z,N3_SheenOut.w);
vec3 l9_51=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_29.xyz,vec3(l9_29.w));
N3_SheenOut=vec4(l9_51.x,l9_51.y,l9_51.z,N3_SheenOut.w);
vec3 l9_52;
#if (sc_DirectionalLightsCount>0)
{
vec3 l9_53;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_56=l9_55<sc_DirectionalLightsCount;
if (l9_56)
{
vec3 l9_57;
if (l9_56)
{
l9_57=sc_DirectionalLights[l9_55].color.xyz;
}
else
{
l9_57=vec3(0.0);
...
if (l9_56)
{
l9_58=sc_DirectionalLights[l9_55].color.w;
}
else
{
l9_58=0.0;
}
vec3 l9_59=l9_57*l9_58;
vec3 l9_60;
if (l9_56)
{
l9_60=-sc_DirectionalLights[l9_55].direction;
}
else
{
l9_60=vec3(0.0);
...
float l9_62=clamp(dot(l9_28,l9_61),0.0,1.0);
l9_54=l9_53+(((((l9_59*3.1415901)*l9_32)*N3_charlieD(l9_43,clamp(dot(l9_28,normalize(l9_61+l9_41)),0.0,1.0)))*(1.0/(4.0*((l9_62+l9_42)-(l9_62*l9_42)))))*l9_62);
l9_53=l9_54;
l9_55++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_67=l9_66<sc_PointLightsCount;
if (l9_67)
{
vec3 l9_68;
if (l9_67)
{
l9_68=sc_PointLights[l9_66].color.xyz;
}
else
{
l9_68=vec3(0.0);
...
if (l9_67)
{
l9_69=sc_PointLights[l9_66].color.w;
}
else
{
l9_69=0.0;
...
if (l9_67)
{
l9_71=sc_PointLights[l9_66].position;
}
else
{
l9_71=vec3(0.0);
}
vec3 l9_72=normalize(l9_71-tempGlobals.SurfacePosition_WorldSpace);
float l9_73=clamp(dot(l9_28,l9_72),0.0,1.0);
l9_65=l9_64+(((((l9_70*3.1415901)*l9_32)*N3_charlieD(l9_43,clamp(dot(l9_28,normalize(l9_72+l9_41)),0.0,1.0)))*(1.0/(4.0*((l9_73+l9_42)-(l9_73*l9_42)))))*l9_73);
l9_64=l9_65;
l9_66++;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_78=l9_77<sc_AmbientLightsCount;
if (l9_78)
{
vec3 l9_79;
if (l9_78)
{
l9_79=sc_AmbientLights[l9_77].color;
}
else
{
l9_79=vec3(0.0);
...
if (l9_78)
{
l9_80=sc_AmbientLights[l9_77].intensity;
}
else
{
l9_80=0.0;
}
l9_76=l9_75+(((l9_79*l9_80)/vec3(3.1415901))*l9_32);
l9_75=l9_76;
l9_77++;
continue;
}
...
#endif
vec3 l9_81=N3_SheenOut.xyz+l9_74;
N3_SheenOut=vec4(l9_81.x,l9_81.y,l9_81.z,N3_SheenOut.w);
N3_SheenOut.w=1.0-(max(max(l9_32.x,l9_32.y),l9_32.z)*0.15700001);
}
if (N3_ClearcoatEnable)
{
...
if (N3_EnableClearcoatTexture)
{
vec2 l9_82=N3_getUV(N3_ClearcoatTextureCoord);
vec2 l9_83;
if (N3_EnableTextureTransform&&N3_ClearcoatTextureTransform)
{
l9_83=N3_uvTransform(l9_82,N3_ClearcoatTextureOffset,N3_ClearcoatTextureScale,N3_ClearcoatTextureRotation);
}
else
{
l9_83=l9_82;
...
#if (clearcoatTextureLayout==2)
{
l9_84=sc_SampleTextureBiasOrLevel(clearcoatTextureDims.xy,clearcoatTextureLayout,clearcoatTextureGetStereoViewIndex(),l9_83,(int(SC_USE_UV_TRANSFORM_clearcoatTexture)!=0),clearcoatTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture),(int(SC_USE_UV_MIN_MAX_clearcoatTexture)!=0),clearcoatTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0),clearcoatTextureBorderColor,0.0,clearcoatTextureArrSC);
}
#else
{
l9_84=sc_SampleTextureBiasOrLevel(clearcoatTextureDims.xy,clearcoatTextureLayout,clearcoatTextureGetStereoViewIndex(),l9_83,(int(SC_USE_UV_TRANSFORM_clearcoatTexture)!=0),clearcoatTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture),(int(SC_USE_UV_MIN_MAX_clearcoatTexture)!=0),clearcoatTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0),clearcoatTextureBorderColor,0.0,clearcoatTexture);
...
#endif
N3_ClearcoatBase=ssSRGB_to_Linear(l9_84.x);
}
N3_ClearcoatBase*=N3_ClearcoatFactor;
if (N3_EnableClearCoatRoughnessTexture)
{
vec2 l9_85=N3_getUV(N3_ClearcoatRoughnessTextureCoord);
vec2 l9_86;
if (N3_EnableTextureTransform&&N3_ClearcoatRoughnessTextureTransform)
{
l9_86=N3_uvTransform(l9_85,N3_ClearcoatRoughnessTextureOffset,N3_ClearcoatRoughnessTextureScale,N3_ClearcoatRoughnessTextureRotation);
}
else
{
l9_86=l9_85;
...
#if (clearcoatRoughnessTextureLayout==2)
{
l9_87=sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,clearcoatRoughnessTextureGetStereoViewIndex(),l9_86,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTextureArrSC);
}
#else
{
l9_87=sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,clearcoatRoughnessTextureGetStereoViewIndex(),l9_86,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTexture);
...
#endif
N3_ClearcoatRoughness=ssSRGB_to_Linear(l9_87.y);
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
vec2 l9_88=N3_getUV(N3_ClearcoatNormalMapCoord);
vec2 l9_89;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
l9_89=N3_uvTransform(l9_88,N3_ClearcoatNormalTextureOffset,N3_ClearcoatNormalTextureScale,N3_ClearcoatNormalTextureRotation);
}
else
{
l9_89=l9_88;
...
#if (clearcoatNormalTextureLayout==2)
{
l9_90=sc_SampleTextureBiasOrLevel(clearcoatNormalTextureDims.xy,clearcoatNormalTextureLayout,clearcoatNormalTextureGetStereoViewIndex(),l9_89,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture),(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0),clearcoatNormalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0),clearcoatNormalTextureBorderColor,0.0,clearcoatNormalTextureArrSC);
}
#else
{
l9_90=sc_SampleTextureBiasOrLevel(clearcoatNormalTextureDims.xy,clearcoatNormalTextureLayout,clearcoatNormalTextureGetStereoViewIndex(),l9_89,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture),(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0),clearcoatNormalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0),clearcoatNormalTextureBorderColor,0.0,clearcoatNormalTexture);
...
#endif
N3_ClearcoatNormal=l9_90.xyz;
N3_ClearcoatNormal*=0.9921875;
}
}
vec3 l9_91=N3_BaseColor;
float l9_92=N3_Opacity;
vec3 l9_93=N3_Normal;
vec3 l9_94=N3_Emissive;
float l9_95=N3_Metallic;
float l9_96=N3_Roughness;
vec3 l9_97=N3_Background;
vec4 l9_98=N3_SheenOut;
float l9_99=N3_ClearcoatBase;
vec3 l9_100=N3_ClearcoatNormal;
float l9_101=N3_ClearcoatRoughness;
vec3 l9_102;
#if (!sc_ProjectiveShadowsCaster)
{
l9_102=l9_93;
...
#else
{
l9_102=Globals.BumpedNormal;
}
#endif
float l9_103=clamp(l9_92,0.0,1.0);
ngsAlphaTest(l9_103);
vec3 l9_104=max(l9_91,vec3(0.0));
vec4 l9_105;
#if (sc_ProjectiveShadowsCaster)
{
l9_105=vec4(l9_104,l9_103);
}
#else
{
l9_105=ngsCalculateLighting(l9_104,l9_103,l9_102,Globals.PositionWS,Globals.ViewDirWS,max(l9_94,vec3(0.0)),clamp(l9_95,0.0,1.0),clamp(l9_96,0.0,1.0),clamp(N3_Occlusion.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
vec4 l9_106=max(l9_105,vec4(0.0));
vec3 l9_107;
#if (!sc_ProjectiveShadowsCaster)
{
l9_107=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_100;
}
#else
{
l9_107=Globals.BumpedNormal;
}
#endif
ngsAlphaTest(Port_Opacity_N405);
vec4 l9_108;
#if (sc_ProjectiveShadowsCaster)
{
l9_108=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#else
{
l9_108=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_107,Globals.PositionWS,Globals.ViewDirWS,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_101,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
tempGlobals=Globals;
N31_PbrIn=l9_106;
N31_EnableTransmission=(int(ENABLE_TRANSMISSION)!=0);
N31_Opacity=l9_92;
N31_Background=l9_97;
N31_EnableSheen=(int(ENABLE_SHEEN)!=0);
N31_SheenColor=l9_98;
N31_EnableClearcoat=(int(ENABLE_CLEARCOAT)!=0);
N31_ClearcoatBase=l9_99;
N31_ClearcoatColor=max(l9_108,vec4(0.0));
N31_Result=N31_PbrIn;
if ((N31_EnableSheen||N31_EnableTransmission)||N31_EnableClearcoat)
{
N31_Result=ssSRGB_to_Linear(N31_Result);
if (N31_EnableSheen)
{
vec3 l9_109=(N31_Result.xyz*N31_SheenColor.w)+N31_SheenColor.xyz;
N31_Result=vec4(l9_109.x,l9_109.y,l9_109.z,N31_Result.w);
}
if (N31_EnableTransmission)
{
N31_Result=mix(vec4(N31_Background,1.0),N31_Result,vec4(ssSRGB_to_Linear(N31_Opacity)));
...
if (N31_EnableClearcoat)
{
vec3 l9_110=N31_Result.xyz+(ssSRGB_to_Linear(N31_ClearcoatColor)*N31_ClearcoatBase).xyz;
N31_Result=vec4(l9_110.x,l9_110.y,l9_110.z,N31_Result.w);
}
N31_Result=ssLinear_to_SRGB(N31_Result);
}
Input1=N31_Result;
